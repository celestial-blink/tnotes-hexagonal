                ...
                <div class="w-full flex flex-col gap-1 md:w-auto md:sticky md:top-0">
                    ...
                    <nav class="custom__shadow rounded-full w-full bg-white md:flex-col md:w-52 md:rounded md:p-1 dark:bg-slate-700 dark:text-white">
                        <ul class="flex justify-between py-2 px-5 md:flex-col md:p-1">
                            <li>
                                <Link href={"/"} class={`flex items-center gap-1 p-1 rounded hover:bg-slate-200 dark:hover:bg-slate-500 ${(location.url.pathname === "/home/" || location.url.pathname === "/") ? "bg-slate-200 dark:bg-slate-500" : ""}`} title="inicio">
                            ...
                            <li>
                                <button class="flex items-center w-full gap-1 p-1 rounded hover:bg-slate-200 dark:hover:bg-slate-500" onClick$={toggleDarkMode}>
